...
runList="preproc_recognition_run_1.feat preproc_recognition_run_2.feat preproc_recognition_run_3.feat \
         preproc_recognition_run_4.feat preproc_recognition_run_5.feat preproc_recognition_run_6.feat \
...
do
  ...
  STAN=$FL_DIR/${r}.feat/reg/example_func2standard.mat
  #flirt -ref $HIRES  -in $FF -applyisoxfm 2 -out $OUTFF -interp spline
  #flirt -ref $HIRES  -in $ff -applyisoxfm 2 -out -init $MAT $outff -interp spline
