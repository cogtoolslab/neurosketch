...
def plot_summary_timecourse(ALLDM, 
    ...
    for this_roi in roi_list:
        ...
        if not os.path.exists(os.path.join(proj_dir,'plots/roi/{}/{}'.format(lookup[this_iv],toop))):
            os.makedirs(os.path.join(proj_dir,'plots/roi/{}/{}'.format(lookup[this_iv],toop)))
        plt.tight_layout()        
